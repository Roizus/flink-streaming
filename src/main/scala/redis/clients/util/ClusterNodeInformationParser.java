...
public class ClusterNodeInformationParser {
  ...
  public HostAndPort getHostAndPortFromNodeLine(String[] nodeInfoPartArray, HostAndPort current) {
    ...
    stringHostAndPort = stringHostAndPort.substring(0,stringHostAndPort.indexOf("@")); // Elimina puerto redireccionamiento.
    String[] arrayHostAndPort = stringHostAndPort.split(":");
    arrayHostAndPort[0] = System.getProperty("redis.host");// Obtiene local-ip en vez de localhost, que viene definido en las cabeceras.
